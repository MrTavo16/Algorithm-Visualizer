  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 gap-6">
      ...
      <div className="flex gap-4">
        <button onClick={handleSortButton} disabled={isSorting} className="bg-blue-500 text-white px-4 py-2 rounded disabled:opacity-50">
          {isSorting ? "Sorting..." : "Sort"}
        </button>
        <button onClick={handleButtonReset} disabled={isSorting} className="bg-gray-500 text-white px-4 py-2 rounded disabled:opacity-50">
          New Array
        </button>
      </div>
    </div>
